$(document).ready(function() {
  ...
  $("form[name='template_data_get']").on('submit',function(e) {
    ...
    var target1 = []; var target2 = [];
    var td_elem1 = {}; var td_elem2 = {};
    ...
    content1.children("tr").each(function(i, elem) {
      td_elem1 = $(elem).children("td").eq(0);
      td_elem1.children().remove();
      target1.push(td_elem1.text());
    });

    content2.children("tr").each(function(i, elem) {
      td_elem2 = $(elem).children("td").eq(0);
      td_elem2.children().remove();
      target2.push(td_elem2.text());
    });
